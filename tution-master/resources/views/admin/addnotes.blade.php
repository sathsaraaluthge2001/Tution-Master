      ...
      <div class="container-fluid py-1">
        <nav arAia-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="text-white opacity-5" href="javascript:;">Notes</a></li>
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Add Notes</li>
          </ol>
          <h6 class="text-white font-weight-bolder ms-2">Add Notes</h6>
        </nav>
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Add Notes</p>
                <button class="btn btn-primary btn-sm ms-auto"> <a class="" href="{{ url('viewnotes') }}">View</a></button>
              </div>
            </div>
            <div class="card-body">
